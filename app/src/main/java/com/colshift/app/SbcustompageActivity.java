...
public class SbcustompageActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.sbcustompage);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		button1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				edittext1.setText(edittext1.getText().toString().replace("+", ""));
				edittext1.setText(edittext1.getText().toString().replace(".", ""));
				tempCache.edit().putString("customPageAwait", "0").commit();
				tempCache.edit().putString("customPageNumber", edittext1.getText().toString()).commit();
				finish();
			}
		});
	}
